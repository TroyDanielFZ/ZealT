...
struct AssociationInfo{
    ...
    QString match;
    QString spliter;
    AssociationInfo(const QString &_type = ""
        , const QString &_command  = "start {%}"
        , const QString & _spliter = "|"
        , const QString &_regex = ""
        , const QString &_match = "*"){
        type=_type;
        command = _command;
        spliter = _spliter;
        regex = _regex;
...
public:
    ...
    // Associations
//    QMap<QString, QString> mapFileAssociations;
    QList<AssociationInfo> lstFileAssociations;
